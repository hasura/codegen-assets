...
// node_modules/common-tags/es/commaLists/commaLists.js @66
...
// src/templates/javascriptExpress.codegen.ts @1
...
const templater = (actionName, actionSdl, derive) => {
  ...
  const codegen = templates_1.javascriptExpressTemplate({
    ...templateParams,
    typeDefs: languages_functional_1.graphqlSchemaToJSDoc(actionSdl)
  });
  const response = [{
